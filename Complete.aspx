<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Complete.aspx.cs" Inherits="ChangePassword.Complete" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form id="form1" runat="server">
      <div>
        <asp:Label ID="lblComplete" runat="server" Font-Size="X-Large" Font-Bold="true" Text="パスワード変更完了" />
        <br />
        <br />
